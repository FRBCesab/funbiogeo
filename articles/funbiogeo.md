...
workflows in functional biogeography. It helps filter sites, species,
and traits based on their trait coverage. It also provides default
diagnostic plots and standard tables summarizing input data.
