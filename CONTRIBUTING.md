...
Conduct](https://github.com/frbcesab/funbiogeo/blob/contribution-guidelines/CODE_OF_CONDUCT.md).
...
writing R code. All functions must start with `fb_`. Functions are
documented with the
...
- Use the template
  [other_issue.md](https://github.com/frbcesab/funbiogeo/blob/contribution-guidelines/.github/ISSUE_TEMPLATE/other_issue.md).
...
- To see if other users have experienced (and potentially already
  ...
  tracker](https://github.com/frbcesab/funbiogeo/issues?q=label%3Abug).
...
- Open a new [Issue](https://github.com/frbcesab/funbiogeo/issues/new).
- Use the template
  [bug_report.md](https://github.com/frbcesab/funbiogeo/blob/contribution-guidelines/.github/ISSUE_TEMPLATE/bug_report.md).
...
Issues](https://github.com/frbcesab/funbiogeo/issues).

- Open a new [Issue](https://github.com/frbcesab/funbiogeo/issues/new).
- Use the template
  [feature_request.md](https://github.com/frbcesab/funbiogeo/blob/contribution-guidelines/.github/ISSUE_TEMPLATE/feature_request.md).
- Provide a clear and descriptive title for the issue to identify the
  suggestion.
- Provide a step-by-step description of the suggested enhancement in as
  many details as possible.
- Explain why this enhancement would be useful to most `funbiogeo`
  users.
...
7.  Submit a [Pull
    ...
    on the [original
    repo](https://github.com/frbcesab/funbiogeo/compare).
