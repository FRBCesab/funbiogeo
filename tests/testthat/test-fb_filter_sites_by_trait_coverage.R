...
test_that(
  "fb_filter_sites_by_trait_coverage() works with occurrence matrices", {  
    
    ## Only numeric trait
    # Working
    expect_silent(
      test_coverage <- fb_filter_sites_by_trait_coverage(
        occ_dat, species_traits, 1
      )
    )
...
test_that(
  "fb_filter_sites_by_trait_coverage() works with abundance matrices", {  
