...
Table: Plotting functions in `funbiogeo` ordered alphabetically with their
required ✳️, optional 🟩, and absent ➖ input datasets. The "Additional input" 
column reflects the need for other arguments.
...
This plot does not tell us if all species with at least 4 traits share the same
trait combination (there are multiple 4 trait combinations), but it's a first indication.
