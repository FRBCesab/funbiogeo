...
The function leverages stacked density plots of trait coverages across sites
...
of occupied sites. 
The left y-axis label species names (in parenthesis) and their rank by
...
represent the number of species having given number of known traits. Also,
...
species have 0 or more known traits, but we show that in the plot as a reference
to see how the proportion decreases with increasing number of traits. The
...
an `sf` object, `environment_raster` is a
