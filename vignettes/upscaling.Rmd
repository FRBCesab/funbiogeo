...
Actually, works with any arbitrary `sf` object

# Aggregating through a SpatRaster grid

We would now like to aggregate our sites at a coarser scale, because 10km by
10km is a too small resolution.
Now, let's say that our next analyses require to work at a coarser resolution
We need to aggregate site data on a new spatial grid (object `SpatRaster` from
