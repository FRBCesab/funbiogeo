...
## Get trait coverage ----
cover <- fb_get_coverage(site_species   = site_species, 
...
```{r 'filter-trait-coverage', eval = FALSE}
## Get trait coverage ----
sel_sites <- fb_filter_coverage(site_species       = site_species, 
                                species_traits     = species_traits,
...
```{r 'compute-cwm', eval = FALSE}
data("site_locations")
data("site_species")
data("species_traits")

## Compute CWM ----
cwm <- fb_cwm(site_species   = site_species, 
              species_traits = species_traits)
...
```{r 'relation-w-environment', eval = FALSE}
## Append information ----
...
```{r 'map-richness', eval = FALSE}
fb_map_raster(ras_richness)
```

```{r 'map-richness-custom', eval = FALSE}
fb_map_raster(ras_richness) + 
