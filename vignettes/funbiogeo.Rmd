...
the right of each point. For example, in our example dataset, 82.6% of species have
...
covering at least 75% of the species. In the end this keeps two traits: body mass
and litter size.
