...
- the **site x species** dataset (example dataset: `species_occs`)
...
## Get trait coverage ----
cover <- fb_get_coverage(site_species  = species_occs, 
...
## Get trait coverage ----
sel_sites <- fb_filter_coverage(site_species      = species_occs, 
                                species_traits     = species_traits,
...
## Compute CWM ----
cwm <- fb_cwm(site_species  = species_occs, 
              species_traits = species_traits)
