...
**Formatting sites x locations data**
...
sites_locations <- fb_format_sites_locations(input_data =  all_data, 
                                             site       = "site", 
                                             longitude  = "longitude", 
                                             latitude   = "latitude",
                                             na_rm      = FALSE)
...
**Formatting sites x species data**
...
ras_richness <- fb_aggregate_site_data(sites_locations = sites_locs, 
                                 site_data       = rich_env, 
                                 agg_grid       = tavg)
