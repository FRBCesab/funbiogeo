...
In `funbiogeo` these three datasets **must be** in a wide format (variables are 
spread across columns), but sometimes information is structured in a long format 
(one column for several variables).
