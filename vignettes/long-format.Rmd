...
This vignette will explain how to process a dataset that is aggregated in long
...
`funbiogeo` provides an excerpt of long format data to show how to use the functions.
This data sits at `system.file("extdata", "woodiv_raw_data.csv", package = "funbiogeo")`.
